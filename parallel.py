...
min_support = 0.001  # Adjust the minimum support value as needed
total_transactions = 0  # Keep track of total number of transactions
all_items_set = set()  # This will hold all unique items
selected_columns = ['Trip Seconds', 'Trip Miles', 'Payment Type']  # Example columns from your dataset

# First pass: create the set of all unique items
for chunk in tqdm(pd.read_csv("Taxi_Trips.csv", chunksize=chunk_size, usecols=selected_columns)):
